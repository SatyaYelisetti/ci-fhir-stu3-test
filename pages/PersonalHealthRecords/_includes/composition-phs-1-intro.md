...
* exactly one section for allergies, with
    * a title
    * a code
    * a text
    * at least one entry or an emptyReason
* exactly one section for medications, with
    * a title
    * a code
    * a text
    * at least one entry or an emptyReason
...
* The system SHALL be able to store and retrieve the following elements:
    ...
    * title
    * section(allergies)
    * section(allergies).title
    * section(allergies).code
    * section(allergies).text
    * section(allergies).entry(allergyIntolerance)
    * section(allergies).emptyReason
    * section(medications)
    * section(medications).title
    * section(medications).code
    * section(medications).text
    * section(medications).entry(medication)
    * section(medications).entry(noRelevantFindingMedication)
    * section(medications).emptyReason
